...
const { DEFAULT_AUDIO_REPRESENTATIONS_SWITCHING_MODE,
        ...
        DEFAULT_VIDEO_TRACK_SWITCHING_MODE } = config;
...
export default class TracksStore extends EventEmitter<ITracksStoreEvents> {
  ...
  public updatePeriodList(manifest : Manifest) : void {
    ...
    const periodsAdded = addedPeriods.reduce((acc : IExposedPeriod[], p) => {
      if (!p.isRemoved) {
  ...
  public setAudioTrack(
    ...
    wantedId : string,
    switchingMode : ITrackSwitchingMode | undefined,
   ...
   * known.
   */
  public getChosenAudioTrack(periodObj : ITMPeriodObject) : ITMAudioTrack | null {
  ...
  public getAvailableAudioTracks(
    periodObj : ITMPeriodObject
  ) : ITMAudioTrackListItem[]|undefined {
  ...
  public getAvailableTextTracks(
    periodObj : ITMPeriodObject
  ) : ITMTextTrackListItem[]|undefined {
  ...
  public getAvailableVideoTracks(
    periodObj : ITMPeriodObject
  ) : ITMVideoTrackListItem[]|undefined {
 ...
 */
function toAudioTrack(adaptation : Adaptation) : ITMAudioTrack {
...
/** Audio track returned by the TracksStore. */
...
/** Text track returned by the TracksStore. */
...
/** Video track returned by the TracksStore. */
...
/** Audio track from a list of audio tracks returned by the TracksStore. */
export interface ITMAudioTrackListItem
  extends ITMAudioTrack { active : boolean }

/** Text track from a list of text tracks returned by the TracksStore. */
export interface ITMTextTrackListItem
  extends ITMTextTrack { active : boolean }

/** Video track from a list of video tracks returned by the TracksStore. */
...
export type IAudioTrackSwitchingMode = ITrackSwitchingMode;
export type IVideoTrackSwitchingMode = ITrackSwitchingMode;
